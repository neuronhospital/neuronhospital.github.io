const C="neuron-static-v4";
const A=["./","./index.html","./opd_booking.html","./eeg_booking.html","./opd_update.html","./eeg_update.html","./statistics.html","./css/base.css","./js/config.js","./js/api.js","./js/utils.js","./js/idb.js","./js/common.js","./js/schedule.js","./js/opd.js","./js/opd_booking.js","./js/eeg.js","./js/secure.js","./js/update.js","./js/stats.js","./js/recovery.js","./manifest.webmanifest"];
